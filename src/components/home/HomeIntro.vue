<template>
  <Section class="home-intro" dark="true" dots="true">
    <div class="home-cols grid-cols grid-cols--2 grid-cols--gap-small">
      <div class="home-cols__left">

        <h1 class="home-title">
          Build <br class="show-for-small"/>
          <VueTyper :text="words" :type-delay="30" caret-animation="smooth" initial-action="erasing"/>
          <br/> websites & apps
          <br/> with Vue.js
        </h1>

        <p class="home-links">
          <g-link class="button primary button--large" to="/docs">
            Get started
          </g-link>
        </p>
        ...
        <p class="home-info">
          ...
          <a href="//github.com/gridsome/gridsome" rel="noopener noreferrer" target="_blank">
            <span>GitHub (v{{ $static.metaData.apiVersion }})</span>
          </a>
        </p>
      ...
      <div class="home-cols__right">
        <div class="home-anim">
          <div class="home-anim__source-logos">
            <g-image alt="Logos" blur="1" src="~/assets/images/cms-logos.png"/>
          </div>
          <div class="home-anim__lines-in">
            <lines-in/>
          </div>
          <div class="home-anim__lines-out">
            <lines-out/>
          </div>
          <div class="home-anim__logo">
            <Logo/>
          </div>
        </div>
      </div>
...
<script>
  ...
  import Logo from '~/assets/images/frontline-symbol.svg';
